...
OUTPUT_DIR = BASE_DIR / "OOD_training_outputs" / "unweighted_baseline_resnet50_5seeds_1se"
...
def train_one_seed(
    ...
    print("\n" + "=" * 80)
    print(f"Starting OOD baseline seed {seed}")
    print("=" * 80)
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        progress_bar = tqdm(
            train_loader,
            desc=f"Seed {seed} | OOD Epoch {epoch}/{NUM_EPOCHS}",
            leave=True,
        )
...
def evaluate_selected_epoch_for_seed(
    ...
    print("\n" + "-" * 80)
    print(f"Evaluating OOD baseline seed {seed}, selected epoch {selected_epoch}")
    print("-" * 80)
    ...
    val_per_class = compute_per_class_table(
        ...
        seed=seed,
        method_name="ood_baseline_resnet50",
    )
...
def main():
    ...
    print("\n" + "=" * 80)
    print("Final OOD mean, std, and SE across seeds")
    print("=" * 80)
    print(aggregate_df)
    ...
    print("\nSaved all OOD baseline outputs successfully.")
    print(OUTPUT_DIR)
